module.exports = {
  ...
  Token: process.env.Token || "OTEzODg1NjM2OTcxMzYwMzU4.GJpgZD.Mut0ziAqs-TFiWX3RsqZAcrGLRGb65BEGcfpAI", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "913885636971360358", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "yWkO0FbiFQYK3wWi7b1Wqrli4Ie2AB6J", // Discord Client Secret
  ...
  Presence: {
    ...
    name: "Undeva-n balkani", // The message shown
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "f999e0d9954249c0b6cd87a4ee9f3a13", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "cdbf61ca1980439586ebdb7c0efca9d2", // Spotify Client Secret
  },
};
